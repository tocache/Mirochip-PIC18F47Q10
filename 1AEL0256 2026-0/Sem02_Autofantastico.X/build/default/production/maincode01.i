...
configuro:
    ...
    ;cond de las E/S
    movlb 0FH ;Bank 15
    clrf TRISD, 1 ;Todo ((NVMCON1) and 0FFh), 0, a como salida
    clrf ANSELD, 1 ;Todo ((NVMCON1) and 0FFh), 0, a como digital
    bsf TRISB, 0, 1 ;((PORTB) and 0FFh), 0, a como entrada
    bcf ANSELB, 0, 1 ;((PORTB) and 0FFh), 0, a como digital
    bsf WPUB, 0, 1 ;((PORTB) and 0FFh), 0, a cobn pullup activado
...
boton:
    movlb 0FH
    btfsc PORTB, 0, 1 ;pregunto si presione boton en ((PORTB) and 0FFh), 0, a
    return
    movlb 0H
    movlw 3
...
siguiente:
    movlb 0FH
    btfss PORTB, 0, 1 ;pregunto si solte boton en ((PORTB) and 0FFh), 0, a
    bra siguiente
    movlb 0H
...
visualizacion:
    ...
    movff TABLAT, LATD ;muevo TABLAT hacia ((NVMCON1) and 0FFh), 0, a
    call retardo
    movlb 0H
    movlw 13
