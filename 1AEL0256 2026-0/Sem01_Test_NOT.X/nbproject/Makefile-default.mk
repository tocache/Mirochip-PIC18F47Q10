...
FINAL_IMAGE=${DISTDIR}/Sem01_Test_NOT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=maincode_Q84.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/maincode_Q84.o
POSSIBLE_DEPFILES=${OBJECTDIR}/maincode_Q84.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/maincode_Q84.o

# Source Files
SOURCEFILES=maincode_Q84.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Sem01_Test_NOT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F57Q84
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Sem01_Test_NOT.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/maincode_Q84.o: maincode_Q84.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/maincode_Q84.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/maincode_Q84.o \
	maincode_Q84.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Sem01_Test_NOT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F57Q84 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Sem01_Test_NOT.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
