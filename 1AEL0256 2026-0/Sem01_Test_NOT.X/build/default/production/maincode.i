...
configuro:
    ...
    bsf TRISB, 0, 1 ;((PORTB) and 0FFh), 0, a entrada
    bcf ANSELB, 0, 1 ;((PORTB) and 0FFh), 0, a digital
    bcf TRISD, 0, 1 ;((PORTD) and 0FFh), 0, a salida
    bcf ANSELD, 0, 1 ;((PORTD) and 0FFh), 0, a digital

inicio:
    btfss PORTB, 0, 1 ;Pregunto si ((PORTB) and 0FFh), 0, a es uno
    bra noescierto ;Falso a si ((PORTB) and 0FFh), 0, a=1
    bra escierto ;Verdad a si ((PORTB) and 0FFh), 0, a=1
