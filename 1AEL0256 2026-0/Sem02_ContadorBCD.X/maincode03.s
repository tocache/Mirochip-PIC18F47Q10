...
upcino:
    ...
    ORG 000300H	;valores desde el 200H al 209H
...
configuro:
    ...
    bsf TRISB, 5, 1	;RB5 es entrada
    bcf ANSELB, 5, 1	;RB5 es digital
    bsf WPUB, 5, 1	;RB5 con pullup activada    
    movlw 80H
...
;subrutina para el boton en RB5
botonRB5:
    movlb 0FH		;Bank15
    btfsc PORTB, 5, 1	    ;preguntando si pulse el boton en RB5
    return
    movlb 0H		;Bank0
    movlw 4
    movwf CUENTA, 1	;fuerzo valor de CUENTA a 4
    call visualizar_7seg
    return
    
    
;subrutina de visualizacion
visualizar_7seg:
    movlb 0H		;Bank0
