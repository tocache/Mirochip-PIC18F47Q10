...
configuro:
    ...
    bsf TRISB, 5, 1 ;((PORTB) and 0FFh), 5, a es entrada
    bcf ANSELB, 5, 1 ;((PORTB) and 0FFh), 5, a es digital
    bsf WPUB, 5, 1 ;((PORTB) and 0FFh), 5, a con pullup activada
    movlw 80H
    movwf TRISC, 1 ;((PORTC) and 0FFh), 6, a al ((PORTC) and 0FFh), 0, a como salidas
    movwf ANSELC, 1 ;((PORTC) and 0FFh), 6, a al ((PORTC) and 0FFh), 0, a como digitales
...
;subrutina del boton en ((PORTB) and 0FFh), 4, a
botonRB4:
    movlb 0FH ;Bank15
    btfsc PORTB, 4, 1 ;pregunto si ((PORTB) and 0FFh), 4, a=0 (si presionaste boton)
...
;subrutina para el boton en ((PORTB) and 0FFh), 5, a
botonRB5:
    movlb 0FH ;Bank15
    btfsc PORTB, 5, 1 ;preguntando si pulse el boton en ((PORTB) and 0FFh), 5, a
    return
    movlb 0H ;Bank0
    movlw 4
...
visualizar_7seg:
    ...
    movff TABLAT, LATC ;envio de lo leido por TBLPTR hacia ((NVMCON1) and 0FFh), 0, a
    return
