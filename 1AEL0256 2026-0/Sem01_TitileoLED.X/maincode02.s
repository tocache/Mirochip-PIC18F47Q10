...
configuro:
    ...
    bcf TRISA, 0, 1	;RA0 como salida
    bcf ANSELA, 0, 1	;RA0 como digital
    
inicio:
    bsf LATC, 0, 1	;RC0 = 1 prendemos el primer LED
    bcf LATA, 0, 1	;RA0 = 0 apagamos el segundo LED
    call retardo	;subrutina de retardo
    bcf LATC, 0, 1	;RC0 = 0 apagamos el primer LED
    bsf LATA, 0, 1	;RA0 = 1 encendemos el segundo LED
    call retardo	;subrutina de retardo
